...
def ws_receive(message):
        ...
        # tem = str(np.random.randint(20, 30))
        # hum = str(np.random.randint(20, 30))
        # while 1:
...
#     query5 = cursor.fetchone()
#
#     m = {"time1": query1[1], "tem1": query1[2], "hum1": query1[3], "time2": query2[1], "tem2": query2[2],
#          "hum2": query2[3],
#          "time3": query3[1], "tem3": query3[2], "hum3": query3[3], "time4": query4[1], "tem4": query4[2],
#          "hum4": query4[3],
#          "time5": query5[1], "tem5": query5[2], "hum5": query5[3]}
#
#     cursor.close()
