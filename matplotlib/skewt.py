...
class SkewXTick(maxis.XTick):
    ...
    @property
    def grid0n(self):
        return (self._grid0n and (self._has_default_loc() or
    ...
    @property
    def tick10n(self):
        return self._tick10n and self._need_lower()

    @tick10n.setter
    def tick10n(self, value):
        self._tick10n = value

    @property
    def label10n(self):
        return self._label10n and self._need_lower()

    @label10n.setter
    def label10n(self, value):
        self.label10n = value

    @property
    def tick20n(self):
        return self._tick20n and self._need_upper()

    @tick20n.setter
    def tick20n(self, value):
        self._tick20n = value

    @property
    def label20n(self):
        return self._label20n and self._need_upper()

    @label20n.setter
    def label20n(self, value):
        self._label20n = value
...
class SkewXAxes(Axes):
    ...
    def _set_lim_add_transforms(self):
        rot = 30
